...
ggtitle("Visualizing COVID-19")+
labs(y= "Cumulative Confirmed Cases")+
geom_line()+
#ggsave(file = "visualizing COVID-19.png", width=8, height=8, dpi=400)
theme_dark()+
...
labs(y = "Cumulative confirmed cases", title = "China vs World (COVID confirmed)")+
theme(plot.title = element_text(hjust = 0.5))+
theme(plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"))+
theme_light()
...
labs(y = "Cumulative confirmed cases", title = 'Trend Line to china')+
...
geom_line()+
labs(title = 'hardest hit countries')